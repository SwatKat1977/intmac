...
ReleaseCycleDetailsPane::ReleaseCycleDetailsPane( wxWindow *parent
                                                , const wxSize &size )
                       : wxPanel( parent
                                , wxID_ANY
                                , wxDefaultPosition
                                , size )
{
    ...
    wxTextCtrl *txtName = new wxTextCtrl( this
                                        ...
                                        , wxSize( 200, -1 )
                                        , 0 );
    txtName->SetToolTip( _( "Required release name" ) );
    controlGrid->Add(txtName, 0, wxALL, 5);
    
    //////////////////////////////////////
    //  Release ID label and and input box
    //////////////////////////////////////
    wxStaticText *labelReleaseID = new wxStaticText( this
                                                   , wxID_ANY
                                                   , _( "Release ID:" )
                                                   , wxDefaultPosition
                                                   , wxSize( -1, -1 )
                                                   , wxALIGN_RIGHT );
    controlGrid->Add( labelReleaseID, 0, wxALL | wxALIGN_RIGHT, 5 );
    
    wxTextCtrl *txtReleaseID = new wxTextCtrl( this
                                             , wxID_ANY
                                             , wxT( "" )
                                             , wxDefaultPosition
                                             , wxSize( 200, -1 )
                                             , 0 );
    txtReleaseID->SetToolTip( _( "Required release ID" ) );
    
    controlGrid->Add(txtReleaseID, 0, wxALL, 5);
...
ReleaseCycleDetailsPane::~ReleaseCycleDetailsPane()
{
}
