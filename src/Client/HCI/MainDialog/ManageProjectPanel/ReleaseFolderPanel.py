...
class ReleaseFolderPanel(wx.Panel):


	def __init__(self, parent, panelSize):

		super(ReleaseFolderPanel, self).__init__(parent,  size = panelSize)
		...
		txtName = wx.TextCtrl(self, wx.ID_ANY, "", wx.DefaultPosition
			, wx.Size( 200, -1 ), 0)
		#txtName.SetToolTip("Required folder name")
		...
		txtDescription = wx.TextCtrl(self, wx.ID_ANY, ""
			, wx.DefaultPosition, wx.Size(200, 200)
			, wx.TE_NO_VSCROLL | wx.TE_MULTILINE)									   
