...
def create_blueprint(logger : logging.Logger):
    ...
    async def get_testcases_overview_request():
        return await view.get_testcases_request()
...
class View(BaseView):
    ...
    '''
        return await view.get_testsuites_request()
    ...
    async def get_testsuites_request(self, request_entry : request) -> Response:
        ...
        try:
            ...
            '''
            print("REQ", await request_entry.get_data())
            request_obj : ApiResponse = self._validate_json_body(
                await request_entry.get_data(), self.GET_TESTSUITES_REQUEST_SCHEMA)
            ...
            print("RESP", api_response.body)

            response_json = {
                "data":  api_response.body
            }

            print("RESPONSE TO SEND:", response_json)
